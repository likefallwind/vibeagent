...
- `tests.test_vscode_extension.VsCodeExtensionTests` plus the Node tests under
  ...
  review, explicit worktree opening, deterministic VSIX contents, and JavaScript syntax. A release-
