...
def get_write_process_report(
    ...
    root = Path(project_root).resolve()
    try:
        selected_process_id, selected_content = parse_write_process_request(argument, process_id, content, project_root=root)
    except ValueError as error:
    ...
    *,
    ...
    if argument and argument.strip():
        ...
        if "--stdin-file" in argument:
            ...
            return selected_process_id, selected_content
        else:
