...
def get_help_text() -> str:
    ...
    return "\n".join(
        [
            ...
            "  /check-write-process <id> <text> [--stdin-file PATH] Preview writing stdin text to one running background process; quote text with spaces.",
            "  /write-process <id> <text> [--stdin-file PATH] Write stdin text to one running background process; quote text with spaces.",
