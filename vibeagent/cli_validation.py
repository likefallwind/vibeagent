...
def validate_cli_args(args: argparse.Namespace) -> str | None:
    ...
    if args.ax_screen_reader and (args.json or args.output_format != "text"):
        return "--ax-screen-reader requires text output."
    ...
    if args.prompt_suggestions and (
        ...
        return "--prompt-suggestions requires a one-shot coding task with --print."
