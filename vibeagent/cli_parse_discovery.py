...
from .cli_parse_path_limits import option_flag as _option_flag
from .cli_parse_path_limits import parse_optional_path_limit_argument
from .cli_parse_path_limits import split_named_parts as _split_named_parts
...
def parse_interactive_repo_map_argument(
    ...
    if not argument:
        return None, {}, None, False
    return parse_optional_path_limit_argument(
        argument,
        usage=usage,
        option_specs={
