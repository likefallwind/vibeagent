...
def normalize_compat_arguments(args: argparse.Namespace) -> argparse.Namespace:
    ...
    if args.approval is not None and args.permission_mode is not None and args.approval != args.permission_mode:
        args.compat_error = "--approval and --permission-mode cannot specify different policies."
    args.approval = args.permission_mode or args.approval or "ask"

    if args.max_iterations is not None and args.max_turns is not None and args.max_iterations != args.max_turns:
