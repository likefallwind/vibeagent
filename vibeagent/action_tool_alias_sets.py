...
CLAUDE_TOOL_ALIASES = {
    ...
    "EnterPlanMode": frozenset({"enter_plan_mode"}),
    "ExitPlanMode": frozenset({"exit_plan_mode"}),
    ...
    "SendUserMessage": frozenset({"send_user_message"}),
    ...
    "TeamCreate": frozenset({"team_create"}),
    "TeamDelete": frozenset({"team_delete"}),
...
PROFILE_TOOL_ALIAS_EXPANSIONS = {
    ...
    "TeamCreate": frozenset({"TeamCreate", "team_create"}),
    "TeamDelete": frozenset({"TeamDelete", "team_delete"}),
