...
class CommandTests(unittest.TestCase):
    ...
    def test_parse_local_command_recognizes_local_commands(self) -> None:
        ...
        self.assertEqual(parse_local_command("/agents --max-agents 2"), LocalCommand(type="agents", argument="--max-agents 2"))
        self.assertEqual(parse_local_command("/skills"), LocalCommand(type="skills"))
        self.assertEqual(parse_local_command("/skills --max-skills 3"), LocalCommand(type="skills", argument="--max-skills 3"))
    ...
    def test_help_text_lists_approval_command(self) -> None:
        ...
        self.assertIn("/agents [--max-agents N]", get_help_text())
        self.assertIn("/skills [--max-skills N]", get_help_text())
    ...
    def test_session_commands_render_compact_session_output(self) -> None:
        with tempfile.TemporaryDirectory(prefix="vibeagent-commands-") as base:
            ...
            latest_selected, latest_context, latest_resume_text = get_resume_context("latest", root)
            ...
            latest_compact_selected, latest_compact_context, latest_compact_text = get_compact_context(" LATEST ", root)
        ...
        self.assertEqual(latest_selected, "run-1")
        self.assertEqual(latest_context, context)
        self.assertEqual(latest_resume_text, "Resume context loaded from session run-1.")
        ...
        self.assertEqual(latest_compact_selected, "run-1")
        self.assertEqual(latest_compact_context, context)
        self.assertEqual(latest_compact_text, "Compacted context loaded from session run-1.")
