...
EXPECTED_GATES = {
    ...
    "VA1-RUN": {
        ...
        "tests": {
            ...
            "test_discovers_and_loads_directory_qualified_nested_skills",
            "test_blocked_nested_skill_change_keeps_old_skill_content",
            "test_profile_accepts_directory_qualified_nested_skill",
    ...
    "VA1-DELEGATE": {
        ...
        "tests": {
            ...
            "test_v1_cli_json_can_delegate_with_dynamic_agent_before_repair_and_commit",
            "test_removed_team_lifecycle_tools_are_not_advertised_to_model",
            "test_named_agent_creates_session_derived_team_state",
        },
    },
    "VA1-MONITOR": {
        "tools": {"Monitor"},
