...
class RemoteMarketplaceTests(unittest.TestCase):
    def test_github_marketplace_add_and_update_preserve_remote_source(self) -> None:
        with tempfile.TemporaryDirectory(prefix="vibeagent-remote-market-") as base:
            ...
            with patch("vibeagent.marketplace_acquisition.clone_public_git", side_effect=clone) as fetch:
    ...
    def test_direct_https_catalog_installs_github_plugin_into_runtime(self) -> None:
        with tempfile.TemporaryDirectory(prefix="vibeagent-remote-market-") as base:
            ...
            with patch("vibeagent.marketplace_plugin_fetch.clone_public_git", side_effect=clone) as fetch:
    ...
    def test_marketplace_removed_during_fetch_cannot_leave_orphan_plugin(self) -> None:
        with tempfile.TemporaryDirectory(prefix="vibeagent-remote-market-") as base:
            ...
            with patch("vibeagent.marketplace_plugin_fetch.clone_public_git", side_effect=clone):
