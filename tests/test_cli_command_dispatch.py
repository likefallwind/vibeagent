...
class CliCommandDispatchTests(unittest.TestCase):
    ...
    def test_cli_command_namespace_uses_public_command_exports_only(self) -> None:
        self.assertEqual(len(commands_module.__all__), 570)
    ...
    def test_dispatch_local_flag_preserves_order_and_handler_signatures(self) -> None:
        ...
        self.assertEqual(calls[1], ("run_project_local_flag", project_root, config_root, provider_env, namespace))
        self.assertEqual(calls[2], ("run_command_local_flag", project_root, namespace))
