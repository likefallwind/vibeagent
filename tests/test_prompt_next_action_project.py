...
from vibeagent.prompt_next_action_project import _project_overview_next_action_instruction
from vibeagent.prompt_next_action_project_formatting import (
...
class PromptNextActionProjectTests(unittest.TestCase):
    ...
    def test_available_command_labels_skip_unavailable_commands(self) -> None:
        labels = available_command_labels(
            [
